...
By @Errorshivansh
Now send your `API_ID` same as `APP_ID` to Start Generating Session.\n You can Support On @EivaSupport join Please """
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Channel', url='https://t.me/TheEiva'),
                InlineKeyboardButton('Developer', url='https://t.me/Eivasupport')
            ],
